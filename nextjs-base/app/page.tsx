...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background via-gray-900 to-gray-950 dark:from-background dark:via-gray-900 dark:to-gray-950 text-white overflow-hidden min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[{
              ...
              description: "Streamline your business with AI-powered insights and automated workflows.",
              icon: <Zap className="w-12 h-12 text-blue-400" />
            },
            {
              title: "Seamless Integration",
              description: "Connect your entire retail ecosystem with our unified platform.",
              icon: <RefreshCw className="w-12 h-12 text-blue-400" />
            },
            {
              title: "Growth Focused",
              description: "Scale your business with tools designed for modern retail success.",
      ...
      {/* Streamline Your Operations Section (Inspired by Dutchie) */}
      <motion.section 
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[ 
            {
              title: "One Click Social Login",
              description: "Let users sign in instantly using their existing social accounts, eliminating passwords or lengthy sign-ups for seamless onboarding.",
              icon: <Fingerprint className="w-10 h-10 text-blue-400" />
            },
            {
              title: "Cart Streaming and Loyalty",
              description: "Engage users with real-time updates and personalized suggestions, boosting conversions and driving repeat business with a loyalty program.",
              icon: <ShoppingCart className="w-10 h-10 text-blue-400" />
            },
            {
              title: "Back in Stock Notifications",
              description: "Instantly alert customers when their favorite items are available again, driving urgency and boosting conversions on missed opportunities.",
              icon: <Bell className="w-10 h-10 text-blue-400" />
            },
            {
              title: "Next Generation Metrc Connect API",
              description: "Take cannabis compliance to the next level with faster, more seamless integration and real-time data sync for automated accuracy.",
              icon: <Link2 className="w-10 h-10 text-blue-400" />
            },
            {
              title: "Self Service Kiosks",
              description: "Put the power in your customers' hands for a faster, more efficient way to shop, order, and pay, reducing wait times and enhancing experience.",
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="space-y-4 p-6 bg-white/10 dark:bg-white/10 rounded-lg hover:bg-white/15 transition-colors duration-300"
            >
