...
const TableOfContents = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = tocData.map(section => ({
        id: section.id,
        title: section.title
      }));
  ...
  return (
    <div className="sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto">
      <h4 className="font-semibold mb-4 text-foreground">Table of Content</h4>
      <div className="space-y-3">
        {tocData.map((section) => (
          <div key={section.id} className="group">
            <button
              onClick={() => scrollToSection(section.id)}
              className={`text-left w-full text-sm font-medium transition-colors hover:text-blue-400 ${
...
const Pagination = () => {
  const sections = [
    { id: 'pos-help-guide', title: 'POS Help Guide' },
    { id: 'user-dropdown-menu', title: 'User Dropdown Menu' },
    { id: 'action-icons', title: 'Action Icons' },
    { id: 'dashboard-overview', title: 'Dashboard Overview' },
    { id: 'recent-activities', title: 'Recent Activities' },
    { id: 'fulfillment-section', title: 'Fulfillment Section' },
    { id: 'customer-management', title: 'Customer Management' },
    { id: 'promotions-section', title: 'Promotions Section' }
  ];
  ...
  return (
    <div className="flex justify-between items-center mt-16 pt-8 border-t border-slate-700/40">
      <div className="flex-1">
        <button
          onClick={() => scrollToSection('pos-help-guide')}
      ...
      <div className="flex gap-4">
        {sections.map((section, index) => (
          <button
            key={section.id}
            onClick={() => scrollToSection(section.id)}
            className="px-3 py-1 rounded-md bg-slate-700/40 hover:bg-slate-700/60 text-gray-300 hover:text-white transition-colors"
          >
            {index + 1}
          </button>
        ))}
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl font-sans text-[1.08rem] bg-background">
          <div className="mx-auto">
            <Typography>
                ...
                <div id="activity-tab" className="mb-8">
                  ...
                  <div className="overflow-x-auto mb-6">
                    <table className="min-w-full bg-slate-700 rounded-lg">
                      <thead>
                        <tr>
                          <th className="px-8 py-4 pl-16 text-left text-gray-100"> 1.What It Shows</th>
              ...
              <section id="recent-activities" className="mb-16">
              ...
              {/* Fulfillment Section */}
              <section id="fulfillment-section" className="mb-16">
                ...
                <div id="pos-point-of-sale" className="mb-8">
                ...
                <div id="order-ahead" className="mb-8">
              ...
              <section id="customer-management" className="mb-16">
                ...
                <div id="customer-groups" className="mb-8">
                ...
                <div id="rewards-and-types" className="mb-8">
              ...
              {/* Promotions Section */}
              <section id="promotions-section" className="mb-16">
                ...
                <div id="loyalty-rewards" className="mb-8">
